...
class HudNavRail extends StatelessWidget {
  ...
  const HudNavRail({super.key, required this.currentIndex, required this.onTap});
  ...
  Widget build(BuildContext context) {
    return Container(
      width: 64,
      color: const Color(0xFF040A1A).withOpacity(0.95),
      child: Column(
          ...
          return GestureDetector(
            ...
            child: AnimatedContainer(
              ...
              decoration: BoxDecoration(
                ...
                color: isActive ? HudColors.cyan.withOpacity(0.12) : Colors.transparent,
                border: Border.all(
              ...
              child: Column(
                children: [
                  ...
                  Text(
                    _items[i].$2,
                    style: HudTextStyles.mono(6, color: isActive ? HudColors.cyan : HudColors.textMuted),
                  ),
                ],
              ),
            ),
